...
namespace EmMana.EmployeeMemoryProvider
{
    public class EmployeeInMemory: IEmployeeDataAccess
    {
        private List<EmployeeCommon> employees = new List<EmployeeCommon>
        {
            ...
            new EmployeeCommon{Id=2, FirstName="Jean",LastName="Grey",Email="jGrey@yahoo.com",Phone="458-789-2365",DepartmentId=4,GenderId=2},
            new EmployeeCommon{Id=3, FirstName="Jon",LastName="Snow",Email="jonsnow@gmail.com",Phone="365-458-2563",DepartmentId=5,GenderId=1},
